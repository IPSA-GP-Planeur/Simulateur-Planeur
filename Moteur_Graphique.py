...
def Display(positionY,vitesseVerticale,vx_new,h,freins):
    ...
    rect_form=pygame.Rect(0,largeur/2+positionY*12,longueur,largeur)
    
    pygame.draw.rect(window_surface,dirt,rect_form)
    
    rect_sky=pygame.Rect(0,0,longueur,largeur/2+positionY*12)
    
    pygame.draw.rect(window_surface,sky,rect_sky)
    
    pygame.draw.line(window_surface,black,[0,largeur/2+positionY*12],[longueur,largeur/2+positionY*12],5)
